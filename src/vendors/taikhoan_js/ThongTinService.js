function ThongTinService() {
    ...
    this.ThongTinNguoiDung = function () {
        $("#btnThongTinNguoiDung").click(function () {
            ...
            var thongtinTK = JSON.parse(jsonThongTinTK);
            var taikhoan = thongtinTK[0].TaiKhoan;
            var urlApi = "http://sv.myclass.vn/api/QuanLyTrungTam/ThongTinNguoiDung?taikhoan=" + taikhoan;
            $.ajax({
                type: 'GET',
                url: urlApi,
                success: function (ketqua) {
    ...
    this.LoadChiTietKhoaHocDangCo = function(){
        ...
        $.ajax({
            ...
            success: function (ketqua) {
                ...
                document.getElementById("hinhanh1").setAttribute("src", `resources/img/img${rand}.jpg`);
                document.getElementById("hinhanh2").setAttribute("src", `resources/img/img${rand}.jpg`);
                document.getElementById("luotxem1").innerHTML = "Lượt xem: " + ketqua.LuotXem;
