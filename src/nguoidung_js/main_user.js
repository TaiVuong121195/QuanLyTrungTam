...
function BatLoiDuLieu(taikhoan, matkhau, hoten, email, sodt, maloainguoidung) {
    ...
    if (validate.KiemTraEmail(email)) {
        ...
        loi++;
        DomID("email").setAttribute("placeholder", "Bạn chưa nhập email hoặc email không hợp lệ");
    }
    if (validate.KiemTraSoDT(sodt)) {
        ...
        loi++;
        DomID("sodt").setAttribute("placeholder", "Bạn chưa nhập số điện thoại hoặc SDT không hợp lệ");
    }
    if (KiemTraDauVaoRong("maloainguoidung", maloainguoidung) == true) {
        loi++;
        DomID("maloainguoidung").setAttribute("placeholder", "Bạn chưa nhập mã loại người dùng");
    }
    if (loi != 0) {
        return true;
    } else {
...
function BatLoiDuLieuCapNhat(taikhoan, matkhau, hoten, email, sodt, maloainguoidung) {
    var loi = 0;
    // Kiểm tra validation
    ...
    if (KiemTraDauVaoRong("matkhaucapnhat", matkhau) == true) {
        loi++;
        DomID("matkhaucapnhat").setAttribute("placeholder", "Bạn chưa nhập mật khẩu");
    }
    ...
    if (validate.KiemTraSoDT(sodt)) {
        ...
        loi++;
        DomID("sodtcapnhat").setAttribute("placeholder", "Bạn chưa nhập số điện thoại");
    }
    if (KiemTraDauVaoRong("maloainguoidungcapnhat", maloainguoidung) == true) {
        loi++;
        DomID("maloainguoidungcapnhat").setAttribute("placeholder", "Bạn chưa nhập mã loại người dùng");
    }
...
function ChinhSuaNguoiDung() {
    ...
    if (BatLoiDuLieuCapNhat(taikhoan, matkhau, hoten, email, sodt, maloainguoidung)) {
        swal("Oops", "Dữ liệu nhập chưa hợp lệ!", "error");
        return;
    } else {
