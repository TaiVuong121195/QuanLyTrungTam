...
function ThemKhoaHoc() {
    ...
    var khoahoc = new KhoaHoc(makhoahoc, tenkhoahoc, mota, luotxem, nguoitao, hinhanh);
...
function ChinhSuaKhoaHoc() {
    ...
    // cập nhật khóa học
    var khoahoc = new KhoaHoc(makhoahoccapnhat, tenkhoahoccapnhat, motacapnhat, luotxemcapnhat, hinhanhcapnhat);
